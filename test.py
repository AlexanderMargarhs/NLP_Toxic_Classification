...
if __name__ == "__main__":
	EMBEDDING_FILE = 'Data_GR/glove.6B.50d.txt'  # Computed a GloVe embedding from corpus
	TRAIN_DATA_FILE = 'Data_GR/train.csv'  # Training Data
	TEST_DATA_FILE = 'Data_GR/test.csv'  # Testing Data

	models = ['Models_GR/model41.h5', 'Models_GR/model42.h5', 'Models_GR/model43.h5', 'Models_GR/model44.h5']
