...
if __name__ == "__main__":
    ...
    best_model = 'Models_GR/model44.h5'
    ...
    plt.savefig("Images/GRU_2_ROC_GR")

    submission[["subtask_a"]] = prediction
    submission.to_csv('Predictions_GR/submission18.csv', index=False)
